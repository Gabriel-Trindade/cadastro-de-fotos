...
<?= $this->Form->create($photo, ['type' => 'file', 'class' => 'needs-validation', 'novalidate' => true]) ?>
<div class="card mt-5">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <?= $this->Form->control('file_path', ['label' => 'Arquivo', 'type' => 'file', 'class' => 'form-control', 'required' => true]) ?>
        </div>
    </div>
